"""
Darwinian — Phase 1 v3 全局强类型 schema 定义

所有 agents（phase_a_orchestrator / proposal_elaborator / proposal_tournament /
novelty_booster / feasibility_challenger / contradiction_detector）通过这些
Pydantic v2 schema 在 ResearchMaterialPack / ResearchProposal 等容器里流转数据。
"""
